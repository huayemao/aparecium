...
const ProvincePreview = ({ province }) => {
  ...
  return (
    <Link href={hasData ? `/provinces/${slug}` : ""}>
      <a className="flex p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
